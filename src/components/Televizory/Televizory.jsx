...
import telev from "../../assets/img/telev.webp";
const Televizory = () => {
  return (
    <div>
      <div className="container mx-auto px-10">
        <h1 className="text-black font-bold text-2xl">Телевизоры</h1>
          ...
          <a href="#" className="relative w-52">
            ...
            <div>
              <div class="flex items-center space-x-0.5 mb-0.5">
                ...
                <span class="text-gray-400 line-through text-sm">3 048</span>
              ...
              <p class="overflow-ellipsis overflow-hidden ellipsis-vertical text-sm hover:text-[#ffc01f]">
                Телевизор Osten OTD43HF445A7, 43 дюйм.
              </p>
            </div>
          </a>
          <a href="#" className="relative w-52">
