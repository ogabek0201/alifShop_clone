...
import telev from "../../assets/img/kon.webp";

const Kondisioner = () => {
  return (
    <div>
      <div className="container mx-auto px-10">
        <h1 className="text-black font-bold text-2xl">Кондиционеры</h1>
          ...
          <a href="#" className="relative w-52">
            ...
            <div>
              <div class="flex items-center space-x-0.5 mb-0.5">
                <span class="font-family-bold text-base">4 799</span>
                <span class="font-family-bold text-base"> c.</span>
                <span class="text-gray-400 line-through text-sm">4 849</span>
              ...
              <p class="overflow-ellipsis overflow-hidden ellipsis-vertical text-sm hover:text-[#ffc01f]">
                Кондиционер Gree Bora GWH12AAB-K3NNA2A, 12 K
              </p>
            </div>
          </a>
          <a href="#" className="relative w-52">
